...
background: linear-gradient(90deg, rgba(71,145,149,1) 0%, rgba(22,57,69,1) 61%, rgba(18,9,41,1) 100%);
  color: #fff;
...
<body>
  ...
  <div class='control block-cube block-input'>
    <input name="confirm_pass" placeholder='Confirm Password' type='password'>
    <div class='bg-top'>
      <div class='bg-inner'></div>
    </div>
    <div class='bg-right'>
  ...
  <button class='btn block-cube block-cube-hover' type='submit' name="reg">
    <div class='bg-top'>
      <div class='bg-inner'></div>
    </div>
    <div class='bg-right'>
  ...
  <br>
        <p class"p1"> Already a member? <a href="login.php">Login</a>
    </form>
</body>
</html>